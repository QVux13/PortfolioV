...
PROJECTS = [
    {
        ...
        'image': '/media/projects/ecom_python.png',
        'github_link': 'https://github.com/QVux13/Ecommerce',
        'live_demo': '',
    },
    {
    ...
    },
    {
        ...
        'github_link': 'https://github.com/QVux13/PortfolioV',
        'live_demo': '',
    },
    {
        'title': 'Financial Risk Forecasting System',
        'description': 'Data-driven system for predicting financial risk levels using machine learning models. Analyzes market trends and provides risk assessment reports.',
        'categories': ['Models', 'Data Science'],
        'tech_stack': 'Python, NumPy, Pandas, Scikit-learn',
        'image': '/media/projects/Bigdata.png',
        'github_link': 'https://github.com/QVux13/BigData',
        'live_demo': '',
    },
    {
        'title': 'E-commerce Book Store',
        'description': 'Full-stack e-commerce platform for selling books online. Features include advanced search, book recommendations, shopping cart, and payment processing.',
        'categories': ['Web Apps'],
        'tech_stack': 'Node.js, Express, React, MongoDB',
        'image': '/media/projects/ecom_node.png',
        'github_link': 'https://github.com/QVux13/DATN_BookStore',
        'live_demo': '',
    },
    {
        'title': 'HRM Management System',
        'description': 'Web and mobile application for human resource management. Enables employee management, payroll processing, attendance tracking, and performance evaluations.',
        'categories': ['Web Apps'],
        'tech_stack': 'FastAPI, Flutter, PostgreSQL',
        'image': '/media/projects/HRM.jpg',
        'github_link': 'https://github.com/yourusername/hrm-fastapi',
        'live_demo': '',
    },
    {
        'title': 'Decision Support System',
        'description': 'Geospatial decision support system for spatial analysis and data visualization. Uses advanced mapping and GIS analysis to provide actionable insights.',
        'categories': ['Web Apps'],
        'tech_stack': 'Django, Python GIS, HTML/CSS',
        'image': '/media/projects/DSS.jpg',
        'github_link': 'https://github.com/QVux13/DSS',
        'live_demo': '',
    },
]
